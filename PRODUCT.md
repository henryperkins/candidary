...
- Production-owned interface assets include `public/assets/candidary-hero.png`, `public/assets/photos/sq-03.webp`, `public/assets/photos/sq-06.webp`, the PWA icons under `public/icons/`, and `design/assets/candidary-app-icon.svg`. The 720 generated cover files under `public/assets/event-covers/v1/` are global release artwork for the six built-in covers and contain no event data.
