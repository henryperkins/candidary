/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=services/image-decoder/worker/wrangler.jsonc services/image-decoder/worker/worker-configuration.d.ts` (hash: 57d220969b6fe553bb32a823fc1896c4)
// Runtime types generated with workerd@1.20260811.1 2026-09-23 nodejs_compat
interface __BaseEnv_Env {
	DECODER_METRICS?: AnalyticsEngineDataset;
	DECODER_ENVIRONMENT: "preview" | "production";
	UPLOAD_POOL_SIZE: "2";
	PREVIEW_POOL_SIZE: "2";
	UPLOAD_DECODERS: DurableObjectNamespace<import("./index").UploadImageDecoder>;
	PREVIEW_DECODERS: DurableObjectNamespace<import("./index").PreviewImageDecoder>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./index");
		durableNamespaces: "UploadImageDecoder" | "PreviewImageDecoder";
	}
	interface PreviewEnv {
		DECODER_METRICS: AnalyticsEngineDataset;
		DECODER_ENVIRONMENT: "preview";
		UPLOAD_POOL_SIZE: "2";
		PREVIEW_POOL_SIZE: "2";
		UPLOAD_DECODERS: DurableObjectNamespace<import("./index").UploadImageDecoder>;
		PREVIEW_DECODERS: DurableObjectNamespace<import("./index").PreviewImageDecoder>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DECODER_ENVIRONMENT" | "UPLOAD_POOL_SIZE" | "PREVIEW_POOL_SIZE">> {}
}
