/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 127a7eac3074459bce5e3993798dd9c6)
// Runtime types generated with workerd@1.20260811.1 2026-07-21 nodejs_compat
interface __BaseEnv_Env {
	MEDIA_BUCKET: R2Bucket;
	CANONICAL_MEDIA_BUCKET: R2Bucket;
	DB: D1Database;
	IMAGE_METRICS?: AnalyticsEngineDataset;
	HOST_AUTH_RATE_LIMIT: RateLimit;
	RSVP_LOOKUP_RATE_LIMIT: RateLimit;
	GUEST_MESSAGE_RATE_LIMIT: RateLimit;
	IMAGES: ImagesBinding;
	CF_VERSION_METADATA: WorkerVersionMetadata;
	ASSETS: Fetcher;
	APP_ORIGIN: "https://candidary-preview.lfd.workers.dev" | "https://candidary.app";
	ALTERNATE_ORIGINS: "" | "https://candidary.online";
	EMAIL_FROM: "hello@candidary.app";
	IMAGE_DECODER_ENVIRONMENT: "preview" | "production";
	TOKEN_HMAC_KEY: string;
	SESSION_HMAC_KEY: string;
	GUEST_TOKEN_ENCRYPTION_KEY: string;
	LOGIN_HMAC_KEY: string;
	ENTRY_HMAC_KEY: string;
	ENTRY_ENCRYPTION_KEY: string;
	RSVP_LOOKUP_HMAC_KEY: string;
	GUEST_MESSAGE_HMAC_KEY: string;
	ALBUM_SHARE_HMAC_KEY: string;
	ALBUM_SHARE_ENCRYPTION_KEY: string;
	IMAGE_DECODER: Fetcher /* candidary-image-decoder-preview */ | Fetcher /* candidary-image-decoder */;
	IMAGE_PREVIEW_WORKFLOW: Workflow<Parameters<import("./worker/index").ImagePreviewWorkflow['run']>[0]['payload']>;
	UPLOAD_COMPLETION_WORKFLOW: Workflow<Parameters<import("./worker/index").UploadCompletionWorkflow['run']>[0]['payload']>;
	EXPORT_WORKFLOW: Workflow<Parameters<import("./worker/index").ExportWorkflow['run']>[0]['payload']>;
	COVER_RENDER_WORKFLOW: Workflow<Parameters<import("./worker/index").CoverRenderWorkflow['run']>[0]['payload']>;
	COVER_BACKFILL_WORKFLOW: Workflow<Parameters<import("./worker/index").CoverBackfillWorkflow['run']>[0]['payload']>;
	EMAIL?: SendEmail;
}
declare namespace Cloudflare {
	...
	interface PreviewEnv {
		...
		ALBUM_SHARE_HMAC_KEY: string;
		ALBUM_SHARE_ENCRYPTION_KEY: string;
		IMAGE_DECODER: Fetcher /* candidary-image-decoder-preview */;
		IMAGE_PREVIEW_WORKFLOW: Workflow<Parameters<import("./worker/index").ImagePreviewWorkflow['run']>[0]['payload']>;
		UPLOAD_COMPLETION_WORKFLOW: Workflow<Parameters<import("./worker/index").UploadCompletionWorkflow['run']>[0]['payload']>;
		EXPORT_WORKFLOW: Workflow<Parameters<import("./worker/index").ExportWorkflow['run']>[0]['payload']>;
		COVER_RENDER_WORKFLOW: Workflow<Parameters<import("./worker/index").CoverRenderWorkflow['run']>[0]['payload']>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ORIGIN" | "ALTERNATE_ORIGINS" | "EMAIL_FROM" | "IMAGE_DECODER_ENVIRONMENT" | "TOKEN_HMAC_KEY" | "SESSION_HMAC_KEY" | "GUEST_TOKEN_ENCRYPTION_KEY" | "LOGIN_HMAC_KEY" | "ENTRY_HMAC_KEY" | "ENTRY_ENCRYPTION_KEY" | "RSVP_LOOKUP_HMAC_KEY" | "GUEST_MESSAGE_HMAC_KEY" | "ALBUM_SHARE_HMAC_KEY" | "ALBUM_SHARE_ENCRYPTION_KEY">> {}
}
